...
export default function PlatformPage() {
  ...
  return <div className="mx-auto max-w-7xl space-y-8">
    <div className="flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between"><div><p className="text-sm font-semibold text-sky-600">VERSALY PLATFORM</p><h1 className="text-3xl font-black tracking-tight">SaaS Admin Console</h1><p className="mt-2 text-sm text-gray-500">Platform-wide subscription health, customer usage, and business metrics.</p></div><div className="flex gap-2"><Link href="/platform/automation" className="rounded-xl border px-4 py-2 text-sm font-semibold hover:bg-gray-50">Automation usage</Link><Link href="/platform/support" className="rounded-xl bg-sky-600 px-4 py-2 text-sm font-bold text-white hover:bg-sky-500">Support operations</Link><Link href="/" className="rounded-xl border px-4 py-2 text-sm font-semibold hover:bg-gray-50">Open CRM</Link></div></div>
