...
export default function Dashboard() {
  ...
  // 1. Unauthenticated visitors see the Public SaaS Landing Page & Pricing Matrix
  if (status === 'unauthenticated' || (!session?.user && status !== 'loading')) {
    return <LandingPage />;
  }

  // 2. Loading state while session or dashboard data resolves
  ...
  const attentionItems = [
    {
      ...
      icon: '⏰',
      badgeColor: 'text-red-600 bg-red-50 dark:bg-red-950/50 dark:text-red-400',
    },
    {
      label: 'Due today',
      ...
      urgent: false,
      icon: '📅',
      badgeColor: 'text-amber-600 bg-amber-50 dark:bg-amber-950/50 dark:text-amber-400',
    },
    {
      ...
      urgent: false,
      icon: '💬',
      badgeColor: 'text-sky-600 bg-sky-50 dark:bg-sky-950/50 dark:text-sky-400',
    },
    {
      ...
      icon: '⚠️',
      badgeColor: 'text-rose-600 bg-rose-50 dark:bg-rose-950/50 dark:text-rose-400',
    },
    {
      ...
      urgent: false,
      icon: '💤',
      badgeColor: 'text-gray-600 bg-gray-100 dark:bg-gray-800 dark:text-gray-400',
    },
  ];
  ...
  return (
    <div className="mx-auto max-w-7xl space-y-7 pb-12">
      ...
      <div className="flex flex-col justify-between gap-4 lg:flex-row lg:items-center">
        <div>
          <div className="flex items-center gap-2 text-xs font-semibold uppercase tracking-wider text-sky-600 dark:text-sky-400">
            ...
            <span>Straten CRM Cloud Platform</span>
      ...
      {/* =========================================
          3. Top Modern KPI Cards with Sparklines
         ========================================= */}
      <section className="grid gap-4 sm:grid-cols-2 xl:grid-cols-4">
        ...
        <div className="relative overflow-hidden rounded-2xl border border-gray-200/80 bg-white p-5 shadow-sm transition hover:shadow-md dark:border-gray-800 dark:bg-gray-900">
          <div className="flex items-start justify-between">
            <div>
              <p className="text-xs font-semibold text-gray-500 dark:text-gray-400">Total Prospects</p>
          ...
          <div className="mt-4 flex items-end justify-between">
            <div className="space-y-0.5">
              ...
              <p className="text-[11px] text-gray-500 dark:text-gray-400">{data.kpis.activeLeads} active in funnel</p>
            </div>
        ...
        <div className="relative overflow-hidden rounded-2xl border border-gray-200/80 bg-white p-5 shadow-sm transition hover:shadow-md dark:border-gray-800 dark:bg-gray-900">
          ...
          <div className="mt-4 flex items-end justify-between">
            <div className="space-y-0.5">
              ...
              <p className="text-[11px] text-gray-500 dark:text-gray-400">{data.kpis.activeLeads} active opportunities</p>
            </div>
            <Sparkline data={data.sparklines?.activePipeline || [10, 14, 12, 18, 16, 22]} color="purple" />
          </div>
        </div>
        ...
        <div className="relative overflow-hidden rounded-2xl border border-gray-200/80 bg-white p-5 shadow-sm transition hover:shadow-md dark:border-gray-800 dark:bg-gray-900">
          <div className="flex items-start justify-between">
            <div>
              <p className="text-xs font-semibold text-gray-500 dark:text-gray-400">Won Revenue</p>
          ...
          <div className="mt-4 flex items-end justify-between">
            <div className="space-y-0.5">
              ...
              <p className="text-[11px] text-gray-500 dark:text-gray-400">{data.kpis.wonLeads} closed deals</p>
            </div>
        ...
        <div className="relative overflow-hidden rounded-2xl border border-gray-200/80 bg-white p-5 shadow-sm transition hover:shadow-md dark:border-gray-800 dark:bg-gray-900">
          <div className="flex items-start justify-between">
            <div>
              <p className="text-xs font-semibold text-gray-500 dark:text-gray-400">Conversion Rate</p>
              <h3 className="mt-2 text-3xl font-extrabold tracking-tight text-gray-900 dark:text-white">
          ...
          <div className="mt-4 flex items-end justify-between">
            <div className="space-y-0.5">
              ...
              <p className="text-[11px] text-gray-500 dark:text-gray-400">{data.kpis.lostLeads} archived lost</p>
            </div>
            <Sparkline data={data.sparklines?.conversionRate || [12, 15, 14, 19, 18, 24]} color="amber" />
          </div>
        </div>
      </section>
        ...
        <div className="flex flex-col gap-6">
          ...
          <div className="rounded-2xl border border-gray-200/80 bg-white p-6 shadow-sm dark:border-gray-800 dark:bg-gray-900">
            <div className="flex items-center justify-between border-b border-gray-100 pb-3 dark:border-gray-800">
              <h3 className="text-sm font-bold text-gray-900 dark:text-white">Conversion Velocity</h3>
        ...
        <div className="mt-5 grid gap-3 sm:grid-cols-2 lg:grid-cols-5">
          {attentionItems.map((item) => (
            <Link
              key={item.label}
              href={item.href}
              className={`group relative flex flex-col justify-between rounded-xl border p-4 transition-all duration-200 hover:-translate-y-0.5 hover:shadow-sm ${
                item.urgent
                  ? 'border-red-200/80 bg-red-50/40 hover:bg-red-50 dark:border-red-900/40 dark:bg-red-950/20'
                  : 'border-gray-200/80 bg-gray-50/50 hover:bg-white dark:border-gray-800 dark:bg-gray-900/60'
              }`}
            >
              ...
              <div className="mt-3">
                ...
                <p className="mt-1 text-xs font-medium text-gray-600 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white">
                  {item.label}
                </p>
              </div>
            </Link>
